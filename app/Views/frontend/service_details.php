                    ...
                    <div class="breadcrumb-wrapper">
                        <div class="breadcrumb-cnt">
                            ...
                            <div class="breadcrumb-list">
                                <a href="index.html">Home</a><img src="<?= base_url()?>/public/assets/img/inner-pages/breadcrumb-arrow.svg"
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-lg-6 wow animate fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="service-img magnetic-item">
                            <img class="img-fluid" src="<?= base_url()?>/public/assets/img/inner-pages/about-service-img.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="how-we-work-section sec-mar">
            ...
            <div class="work-item">
                <div class="container-fluid">
                    <div
                        class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 gy-5 justify-content-center">
                        <div class="col magnetic-item wow animate fadeInUp" data-wow-delay="200ms"
                            data-wow-duration="1500ms">
                            <div class="single-work">
                                <div class="work-icon">
                                    <img src="<?= base_url()?>/public/assets/img/inner-pages/work-icon-01.svg" alt="">
                                </div>
                                <div class="work-content">
                                    <h3>Requirements Gathering.</h3>
                                    <p>Interdum et malesuada fames acchiv Etiam europeat nibhona elementum, accumsan
                                        ona.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col magnetic-item wow animate fadeInUp" data-wow-delay="300ms"
                            data-wow-duration="1500ms">
                            <div class="single-work">
                                <div class="work-icon">
                                    <img src="<?= base_url()?>/public/assets/img/inner-pages/work-icon-02.svg" alt="">
                                </div>
                                <div class="work-content">
                        ...
                        <div class="col magnetic-item wow animate fadeInUp" data-wow-delay="400ms"
                            data-wow-duration="1500ms">
                            <div class="single-work">
                                <div class="work-icon">
                                    <img src="<?= base_url()?>/public/assets/img/inner-pages/work-icon-03.svg" alt="">
                                </div>
                                <div class="work-content">
                        ...
                        <div class="col magnetic-item wow animate fadeInUp" data-wow-delay="500ms"
                            data-wow-duration="1500ms">
                            <div class="single-work">
                                <div class="work-icon">
                                    <img src="<?= base_url()?>/public/assets/img/inner-pages/work-icon-04.svg" alt="">
                                </div>
                                <div class="work-content">
                        ...
                        <div class="col magnetic-item wow animate fadeInUp" data-wow-delay="600ms"
                            data-wow-duration="1500ms">
                            <div class="single-work">
                                <div class="work-icon">
                                    <img src="<?= base_url()?>/public/assets/img/inner-pages/work-icon-05.svg" alt="">
                                </div>
                                <div class="work-content">
                ...
                <div class="row">
                    <div class="col-lg-12 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="driscription-img magnetic-item">
                            <img class="img-fluid" src="<?= base_url()?>/public/assets/img/inner-pages/service-driscription-img-1.png" alt="">
                        </div>
                    </div>
                    <div class="driscription-content">
                        <div class="row">
                            <div class="col-md-6 wow animate fadeInUp" data-wow-delay="200ms"
                                data-wow-duration="1500ms">
                                <p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Etiam eu nibh
                                    neque ac, aliquet nunc. In eu ipsum fringilla, accumsan purus vel, pellentesque
                                    purus at eros interdum, in dignissim nulla vestibulum. Nunc sit amet finibus neque
                                    ac, aliquet nunc. In eu ipsum fringilla, accumsan purus vel, pellentesque
                                    purus at eros interdum, in dignissim nulla vestibulum. Nunc sit amet finibus
                                    pellentesque quis magna eu vestibulum. Ut sed commodo neque. Morbi erat
                                    ut, hendrerit vel tortor. In pharetra lectus luctus ornare sollicitudin.</p>
                            </div>
                            <div class="col-md-6 wow animate fadeInUp" data-wow-delay="300ms"
                                data-wow-duration="1500ms">
                                <p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Etiam eu nibh
                                    neque ac, aliquet nunc. In eu ipsum fringilla, accumsan purus vel, pellentesque
                                    purus at eros interdum, in dignissim nulla vestibulum. Nunc sit amet finibus
                ...
                <div class="row gy-5">
                    <div class="col-lg-6 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="faq-img magnetic-item">
                            <img class="img-fluid" src="<?= base_url()?>/public/assets/img/inner-pages/service-faq-img-01.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-center wow animate fadeInRight" data-wow-delay="300ms"
                        data-wow-duration="1500ms">
